      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div class="lg:col-span-5 space-y-6">
          ...
          <div class="space-y-3 pt-2">
            ...
            <div class="flex items-center justify-between p-3.5 rounded-2xl bg-emerald-50 border border-emerald-200 text-xs sm:text-sm">
              <div class="flex items-center gap-3">
                ...
                <div>
                  <span class="font-bold text-neutral-900 block">Direct Clinic Helpline</span>
                  <a href="tel:+923137095454" class="text-emerald-700 font-bold hover:underline">0313-7095454 (+92 313 7095454)</a>
                </div>
              </div>
              <a 
                href="https://wa.me/923137095454?text=FIT" 
                target="_blank"
                class="px-3 py-1.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs shrink-0 shadow-xs"
              >
                WhatsApp
              </a>
            </div>
